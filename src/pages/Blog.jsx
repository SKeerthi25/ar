    ...
    <section className="section-padding container fade-up">
        ...
        <div className="grid-3">
            <div className="glass-card fade-up" style={{ display: 'flex', flexDirection: 'column' }}>
                <img src="/images/port_9.png" style={{ width: '100%', height: '200px', objectFit: 'cover', borderRadius: '8px', marginBottom: '20px' }} alt="Blog 1" />
            ...
            <div className="glass-card fade-up" style={{ display: 'flex', flexDirection: 'column' }}>
                <img src="/images/port_10.png" style={{ width: '100%', height: '200px', objectFit: 'cover', borderRadius: '8px', marginBottom: '20px' }} alt="Blog 2" />
            ...
            <div className="glass-card fade-up" style={{ display: 'flex', flexDirection: 'column' }}>
                <img src="/images/port_11.png" style={{ width: '100%', height: '200px', objectFit: 'cover', borderRadius: '8px', marginBottom: '20px' }} alt="Blog 3" />
